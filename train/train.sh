...
python main.py train --model UFORMER    --noise Random  --b 8  --epochs 1 --neptune offline

python main.py train --model UFORMER    --noise Random  --b 8  --epochs 100    
python main.py train --model UFORMER    --noise Line    --b 8  --epochs 100    
python main.py train --model UFORMER    --noise Scar    --b 8  --epochs 100    
python main.py train --model UFORMER    --noise Hum     --b 8  --epochs 100    
